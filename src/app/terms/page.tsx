...
export const metadata: Metadata = {
  ...
  description: "The terms and conditions that govern your use of Lumina.",
};
...
const sections: LegalSection[] = [
  {
    ...
    paragraphs: [
      "By accessing or using Lumina, the AI search service operated by Lumina Labs Inc. (referred to as Lumina, we, us or our), you agree to be bound by these Terms of Service. If you do not agree with any part of these terms, you must not use the service. If you are using Lumina on behalf of an organization, you represent that you have the authority to bind that organization to these terms.",
    ],
  },
  {
    heading: "Description of the service",
    paragraphs: [
      "Lumina provides an AI powered search engine that processes natural language queries and returns synthesized answers together with citations to original sources. The service is available through our website, mobile applications and browser extensions. We may add, change or remove features at any time as the product evolves.",
    ],
  },
  {
    heading: "Accounts and eligibility",
    paragraphs: [
      "You must be at least 16 years old to create an account. When you register, you agree to provide accurate information and to keep it up to date. You are responsible for maintaining the confidentiality of your login credentials and for all activity that occurs under your account. Notify us immediately at support@lumina.search if you suspect unauthorized use of your account.",
    ],
  },
  {
    heading: "Acceptable use",
    paragraphs: [
      "You agree to use Lumina only for lawful purposes. In particular, you agree not to:",
    ],
    list: [
  ...
  },
  {
    ...
    paragraphs: [
      "Answers produced by Lumina are generated by artificial intelligence based on third party sources. While we work hard to make answers accurate and always provide citations, we cannot guarantee that every answer is complete, current or correct. Answers are provided for informational purposes only and do not constitute professional, legal, medical or financial advice. Always verify important information using the cited sources or a qualified professional.",
    ],
  },
  {
    heading: "Intellectual property",
    paragraphs: [
      "The service, including its software, design, trademarks and content created by us, is owned by Lumina Labs Inc. and protected by intellectual property laws. We grant you a limited, personal, revocable license to use the service in accordance with these terms. Content from third party sources remains the property of its respective owners, and citations link back to those sources.",
    ],
  },
  {
    heading: "Privacy",
  ...
  },
  {
    heading: "Contact",
    paragraphs: [
      "Questions about these terms? Write to us at legal@lumina.search or by post at Lumina Labs Inc., 548 Market Street, San Francisco, CA 94104, United States.",
    ],
  },
];
...
export default function TermsPage() {
  return (
    <LegalPage
      title="Terms of Service"
      updated="June 1, 2026"
      intro="These Terms of Service govern your access to and use of Lumina. Please read them carefully. They describe your rights and responsibilities when using our AI search service."
      sections={sections}
    />
  );
}
